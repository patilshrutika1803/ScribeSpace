...
export default function AdminLogin() {
  const { loginAdmin, isAdmin, isUser } = useAuth()
      ...
      >
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div>
            ...
            <input id="admin-email" type="email" required placeholder="admin@scribespace.com" className={input} />
          </div>
          <div>
            <label htmlFor="admin-password" className={label}>Password</label>
            <input id="admin-password" type="password" required placeholder="••••••••" className={input} />
          </div>
